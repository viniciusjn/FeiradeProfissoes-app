                    ...
                    <Card.Content>
                        <View style={Styles.cardIcons}>
                            <Icon
                                ...
                                size={20}
                            />
                            <Text variant="titleSmall">Média Salarial: <Text style={{ fontWeight: 'bold' }}>R$ 3.804,75</Text> </Text>
                        </View>
                        <View style={Styles.cardIcons}>
                            <Icon
                                source="calendar"
