        ...
        <ScrollView keyboardShouldPersistTaps="always">
            <View>
                    ...
                    <Card.Content>
                        <View style={Styles.cardIcons}>
                            <Icon
                                ...
                                size={20}
                            />
                            <Text variant="titleSmall">Média Salarial: <Text style={{ fontWeight: 'bold' }}>R$ 4.752,14</Text></Text>
                        </View>
                        <View style={Styles.cardIcons}>
                            <Icon
                                source="calendar"
                ...
                <View style={Styles.text}>
                    ...
                    <Text variant="bodyMedium" style={{ marginBottom: 10 }}>A <Text style={{ color: '#7f67be', fontWeight: 'bold' }}> faculdade de direito</Text> é uma das opções mais populares entre os estudantes que desejam seguir uma carreira na área jurídica. É uma formação de ensino superior que oferece formação teórica e prática para aqueles que desejam se tornar advogados, juízes, promotores, delegados, entre outras profissões relacionadas ao campo do direito.</Text>
                    <Text variant="bodyMedium" style={{ marginBottom: 10 }}>Durante o <Text style={{ color: '#7f67be', fontWeight: 'bold' }}> curso de direito</Text>, os alunos aprendem sobre diversas áreas do conhecimento, tais como <Text style={{ color: '#7f67be', fontWeight: 'bold' }}>direito civil, penal, trabalhista, tributário, ambiental</Text>, entre outros. Além disso, eles têm a oportunidade de aprofundar seus conhecimentos em áreas específicas, através de disciplinas optativas e atividades extracurriculares.</Text>
